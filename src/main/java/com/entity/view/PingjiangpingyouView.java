...
public class PingjiangpingyouView extends PingjiangpingyouEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 评奖评优类型的值
		*/
		private String pingjiangpingyouValue;
		/**
		* 审核状态的值
		*/
		private String pingjiangpingyouYesnoValue;
	...
	public PingjiangpingyouView() {

	}

	public PingjiangpingyouView(PingjiangpingyouEntity pingjiangpingyouEntity) {
		try {
			BeanUtils.copyProperties(this, pingjiangpingyouEntity);
			...
			* 获取： 评奖评优类型的值
			*/
			public String getPingjiangpingyouValue() {
				return pingjiangpingyouValue;
			}
			/**
			* 设置： 评奖评优类型的值
			*/
			public void setPingjiangpingyouValue(String pingjiangpingyouValue) {
				this.pingjiangpingyouValue = pingjiangpingyouValue;
			}
			/**
			* 获取： 审核状态的值
			*/
			public String getPingjiangpingyouYesnoValue() {
				return pingjiangpingyouYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setPingjiangpingyouYesnoValue(String pingjiangpingyouYesnoValue) {
				this.pingjiangpingyouYesnoValue = pingjiangpingyouYesnoValue;
			}
