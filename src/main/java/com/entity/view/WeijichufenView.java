...
public class WeijichufenView extends WeijichufenEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 违纪处分类型的值
		*/
		private String weijichufenValue;
		/**
		* 审核状态的值
		*/
		private String weijichufenYesnoValue;
	...
	public WeijichufenView() {

	}

	public WeijichufenView(WeijichufenEntity weijichufenEntity) {
		try {
			BeanUtils.copyProperties(this, weijichufenEntity);
			...
			* 获取： 违纪处分类型的值
			*/
			public String getWeijichufenValue() {
				return weijichufenValue;
			}
			/**
			* 设置： 违纪处分类型的值
			*/
			public void setWeijichufenValue(String weijichufenValue) {
				this.weijichufenValue = weijichufenValue;
			}
			/**
			* 获取： 审核状态的值
			*/
			public String getWeijichufenYesnoValue() {
				return weijichufenYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setWeijichufenYesnoValue(String weijichufenYesnoValue) {
				this.weijichufenYesnoValue = weijichufenYesnoValue;
			}
