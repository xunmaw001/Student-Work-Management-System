...
//                            xueshengEntity.setXueyuanTypes(Integer.valueOf(data.get(0)));   //学院 要改的
...
//                            xueshengEntity.setXueshengShengyuandi(data.get(0));                    //生源地 要改的
//                            xueshengEntity.setXueshengJiazhangText(data.get(0));                    //家长信息 要改的
//                            xueshengEntity.setXueshengJiatingContent("");//详情和图片
