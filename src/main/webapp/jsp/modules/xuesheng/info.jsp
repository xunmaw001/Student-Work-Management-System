                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>学院</label>
                                    <input style="width: 450px" id="xueyuanValue" name="xueyuanValue" class="form-control"
                                           v-model="ruleForm.xueyuanValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>专业</label>
                                    <input style="width: 450px" id="zhuanyeValue" name="zhuanyeValue" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueshengShengyuandi" name="xueshengShengyuandi" class="form-control"
                                               v-model="ruleForm.xueshengShengyuandi" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>家长信息</label>
                                        <input style="width: 450px" id="xueshengJiazhangText" name="xueshengJiazhangText" class="form-control"
                                               v-model="ruleForm.xueshengJiazhangText" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.xueshengJiatingContent != null && ruleForm.xueshengJiatingContent != 'null' && ruleForm.xueshengJiatingContent != '') {
            var xueshengJiatingContentUeditor = UE.getEditor('xueshengJiatingContentEditor');
                xueshengJiatingContentUeditor.ready(function () {
                    ...
                    xueshengJiatingContentUeditor.setDisabled('fullscreen');
            });
        }
    }
