...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //生源地
            var xueshengShengyuandiCell = document.createElement('td');
            xueshengShengyuandiCell.innerHTML = item.xueshengShengyuandi;
            row.appendChild(xueshengShengyuandiCell);


            //家长信息
            var xueshengJiazhangTextCell = document.createElement('td');
            xueshengJiazhangTextCell.innerHTML = item.xueshengJiazhangText;
            row.appendChild(xueshengJiazhangTextCell);
