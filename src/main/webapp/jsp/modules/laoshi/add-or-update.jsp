                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laoshiUuidNumberDiv">
                                        <label>工号</label>
...
<script>
    ...
    function getDetails() {
        ...
        if (addlaoshi != null && addlaoshi != "" && addlaoshi != "null") {
            //注册表单验证
            $(validform());
            $("#laoshiUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
