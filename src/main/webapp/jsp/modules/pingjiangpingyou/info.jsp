            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">评奖评优登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="pingjiangpingyouUuidNumber" name="pingjiangpingyouUuidNumber" class="form-control"
                                               v-model="ruleForm.pingjiangpingyouUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="pingjiangpingyouName" name="pingjiangpingyouName" class="form-control"
                                               v-model="ruleForm.pingjiangpingyouName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>评奖评优类型</label>
                                    <input style="width: 450px" id="pingjiangpingyouValue" name="pingjiangpingyouValue" class="form-control"
                                           v-model="ruleForm.pingjiangpingyouValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>审核状态</label>
                                    <input style="width: 450px" id="pingjiangpingyouYesnoValue" name="pingjiangpingyouYesnoValue" class="form-control"
                                           v-model="ruleForm.pingjiangpingyouYesnoValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>审核意见</label>
                                        <input style="width: 450px" id="pingjiangpingyouYesnoText" name="pingjiangpingyouYesnoText" class="form-control"
                                               v-model="ruleForm.pingjiangpingyouYesnoText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>审核时间</label>
                                        <input style="width: 450px" id="pingjiangpingyouShenheTime" name="pingjiangpingyouShenheTime" class="form-control"
                                               v-model="ruleForm.pingjiangpingyouShenheTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "pingjiangpingyou/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.pingjiangpingyouContent != null && ruleForm.pingjiangpingyouContent != 'null' && ruleForm.pingjiangpingyouContent != '') {
            var pingjiangpingyouContentUeditor = UE.getEditor('pingjiangpingyouContentEditor');
                pingjiangpingyouContentUeditor.ready(function () {
                    ...
                    pingjiangpingyouContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var pingjiangpingyouFileUrl = "download('" + ruleForm.pingjiangpingyouFile + "')";
        $("#pingjiangpingyouFile").attr("onclick", pingjiangpingyouFileUrl);
