            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生资助登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueshengzizhuUuidNumber" name="xueshengzizhuUuidNumber" class="form-control"
                                               v-model="ruleForm.xueshengzizhuUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueshengzizhuName" name="xueshengzizhuName" class="form-control"
                                               v-model="ruleForm.xueshengzizhuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>学生资助类型</label>
                                    <input style="width: 450px" id="xueshengzizhuValue" name="xueshengzizhuValue" class="form-control"
                                           v-model="ruleForm.xueshengzizhuValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>资助金额</label>
                                        <input style="width: 450px" id="xueshengzizhuJine" name="xueshengzizhuJine" class="form-control"
                                               v-model="ruleForm.xueshengzizhuJine" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>审核状态</label>
                                    <input style="width: 450px" id="xueshengzizhuYesnoValue" name="xueshengzizhuYesnoValue" class="form-control"
                                           v-model="ruleForm.xueshengzizhuYesnoValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>审核意见</label>
                                        <input style="width: 450px" id="xueshengzizhuYesnoText" name="xueshengzizhuYesnoText" class="form-control"
                                               v-model="ruleForm.xueshengzizhuYesnoText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>审核时间</label>
                                        <input style="width: 450px" id="xueshengzizhuShenheTime" name="xueshengzizhuShenheTime" class="form-control"
                                               v-model="ruleForm.xueshengzizhuShenheTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xueshengzizhu/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.xueshengzizhuContent != null && ruleForm.xueshengzizhuContent != 'null' && ruleForm.xueshengzizhuContent != '') {
            var xueshengzizhuContentUeditor = UE.getEditor('xueshengzizhuContentEditor');
                xueshengzizhuContentUeditor.ready(function () {
                    ...
                    xueshengzizhuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var xueshengzizhuFileUrl = "download('" + ruleForm.xueshengzizhuFile + "')";
        $("#xueshengzizhuFile").attr("onclick", xueshengzizhuFileUrl);
