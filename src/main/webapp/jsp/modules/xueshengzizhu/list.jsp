...
<body>
    ...
    <div class="modal fade" id="xueshengzizhuYesnoTypesModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        审核：
                        <div class="col-sm-9">
                            <input type="hidden" id="xueshengzizhuYesnoTypesId">
                            <select id="xueshengzizhuYesnoTypes" name="xueshengzizhuYesnoTypes" class="form-control">
                                <option value="2">同意资助</option>
                                <option value="3">拒绝资助</option>
                            </select>
                        </div>
                    </div>
                       <div class="row">
                           审核意见：
                           <textarea style="width: 450px"  id="xueshengzizhuYesnoText" name="xueshengzizhuYesnoText" class="form-control" placeholder="审核意见"></textarea>
                       </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
                    <button type="button" id="receive" onclick="xueshengzizhuYesnoTypesShenhe()" class="btn btn-primary">审 核</button>
                </div>
            </div>
        </div>
    </div>
...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">学生资助管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">学生资助列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">学生资助列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="xueshengzizhuUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="资助编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        学生资助名称
                                        <div class="layui-input-inline">
                                            <input type="text" id="xueshengzizhuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="学生资助名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        学生资助类型
                                        <div class="layui-input-inline">
                                            <select name="xueshengzizhuTypesSelectSearch"  style="width: 150px;" id="xueshengzizhuTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        审核状态
                                        <div class="layui-input-inline">
                                            <select name="xueshengzizhuYesnoTypesSelectSearch"  style="width: 150px;" id="xueshengzizhuYesnoTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //资助编号
            var xueshengzizhuUuidNumberSearchInput = $('#xueshengzizhuUuidNumberSearch');
            if( xueshengzizhuUuidNumberSearchInput != null){
                if (xueshengzizhuUuidNumberSearchInput.val() != null && xueshengzizhuUuidNumberSearchInput.val() != '') {
                    searchForm.xueshengzizhuUuidNumber = $('#xueshengzizhuUuidNumberSearch').val();
                }
            }
     
            //学生资助名称
            var xueshengzizhuNameSearchInput = $('#xueshengzizhuNameSearch');
            if( xueshengzizhuNameSearchInput != null){
                if (xueshengzizhuNameSearchInput.val() != null && xueshengzizhuNameSearchInput.val() != '') {
                    searchForm.xueshengzizhuName = $('#xueshengzizhuNameSearch').val();
                }
            }
         
                //学生资助类型
            var xueshengzizhuTypesSelectSearchInput = document.getElementById("xueshengzizhuTypesSelectSearch");
            if(xueshengzizhuTypesSelectSearchInput != null){
                var xueshengzizhuTypesIndex = xueshengzizhuTypesSelectSearchInput.selectedIndex;
                if( xueshengzizhuTypesIndex  != 0){
                    searchForm.xueshengzizhuTypes= document.getElementById("xueshengzizhuTypesSelectSearch").options[xueshengzizhuTypesIndex].value;
                }
            }
                 
                //审核状态
            var xueshengzizhuYesnoTypesSelectSearchInput = document.getElementById("xueshengzizhuYesnoTypesSelectSearch");
            if(xueshengzizhuYesnoTypesSelectSearchInput != null){
                var xueshengzizhuYesnoTypesIndex = xueshengzizhuYesnoTypesSelectSearchInput.selectedIndex;
                if( xueshengzizhuYesnoTypesIndex  != 0){
                    searchForm.xueshengzizhuYesnoTypes= document.getElementById("xueshengzizhuYesnoTypesSelectSearch").options[xueshengzizhuYesnoTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("xueshengzizhu/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                xueshengzizhuDelete: 1,
                //本表的
                xueshengzizhuUuidNumber: searchForm.xueshengzizhuUuidNumber,
                xueshengzizhuName: searchForm.xueshengzizhuName,
                xueshengzizhuTypes: searchForm.xueshengzizhuTypes,
                xueshengzizhuYesnoTypes: searchForm.xueshengzizhuYesnoTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //资助编号
            var xueshengzizhuUuidNumberCell = document.createElement('td');
            xueshengzizhuUuidNumberCell.innerHTML = item.xueshengzizhuUuidNumber;
            row.appendChild(xueshengzizhuUuidNumberCell);


            //学生资助名称
            var xueshengzizhuNameCell = document.createElement('td');
            xueshengzizhuNameCell.innerHTML = item.xueshengzizhuName;
            row.appendChild(xueshengzizhuNameCell);


                //相关证明文件
            var xueshengzizhuFileCell = document.createElement('td');
            if(item.xueshengzizhuFile ==null || item.xueshengzizhuFile == '' || item.xueshengzizhuFile == 'null'){
                    xueshengzizhuFileCell.innerHTML = '没有下载文件';
            }else {
                var xueshengzizhuFileFile = document.createElement('button');
                    xueshengzizhuFileFile.innerHTML = '下载';
                var xueshengzizhuFileFileAttr = "download('" + item.xueshengzizhuFile + "')"
                    xueshengzizhuFileFile.setAttribute('onclick',xueshengzizhuFileFileAttr);
                    xueshengzizhuFileCell.appendChild(xueshengzizhuFileFile);
            }
            row.appendChild(xueshengzizhuFileCell);


            //学生资助类型
            var xueshengzizhuTypesCell = document.createElement('td');
            xueshengzizhuTypesCell.innerHTML = item.xueshengzizhuValue;
            row.appendChild(xueshengzizhuTypesCell);


            //资助金额
            var xueshengzizhuJineCell = document.createElement('td');
            xueshengzizhuJineCell.innerHTML = item.xueshengzizhuJine;
            row.appendChild(xueshengzizhuJineCell);
            ...
            //审核状态
            var xueshengzizhuYesnoTypesCell = document.createElement('td');
            xueshengzizhuYesnoTypesCell.innerHTML = item.xueshengzizhuYesnoValue;
            row.appendChild(xueshengzizhuYesnoTypesCell);


            //审核意见
            var xueshengzizhuYesnoTextCell = document.createElement('td');
            xueshengzizhuYesnoTextCell.innerHTML = item.xueshengzizhuYesnoText;
            row.appendChild(xueshengzizhuYesnoTextCell);


            //审核时间
            var xueshengzizhuShenheTimeCell = document.createElement('td');
            xueshengzizhuShenheTimeCell.innerHTML = item.xueshengzizhuShenheTime;
            row.appendChild(xueshengzizhuShenheTimeCell);
            ...
            if(item.xueshengzizhuYesnoTypes == 1){
                //审核按钮
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xueshengzizhu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxueshengzizhu", "addxueshengzizhu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function xueshengzizhuTypesSelectSearch() {
            var xueshengzizhuTypesSelectSearch = document.getElementById('xueshengzizhuTypesSelectSearch');
            if(xueshengzizhuTypesSelectSearch != null) {
                xueshengzizhuTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueshengzizhuTypesOptions != null && xueshengzizhuTypesOptions.length > 0){
                    for (var i = 0; i < xueshengzizhuTypesOptions.length; i++) {
                            xueshengzizhuTypesSelectSearch.add(new Option(xueshengzizhuTypesOptions[i].indexName,xueshengzizhuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
                 
        function xueshengzizhuYesnoTypesSelectSearch() {
            var xueshengzizhuYesnoTypesSelectSearch = document.getElementById('xueshengzizhuYesnoTypesSelectSearch');
            if(xueshengzizhuYesnoTypesSelectSearch != null) {
                xueshengzizhuYesnoTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueshengzizhuYesnoTypesOptions != null && xueshengzizhuYesnoTypesOptions.length > 0){
                    for (var i = 0; i < xueshengzizhuYesnoTypesOptions.length; i++) {
                            xueshengzizhuYesnoTypesSelectSearch.add(new Option(xueshengzizhuYesnoTypesOptions[i].indexName,xueshengzizhuYesnoTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            ...
            function openYesnoTypes(id) {
                $("#xueshengzizhuYesnoTypesId").val(id)
                $('#xueshengzizhuYesnoTypesModal').modal('show');
            }

            function xueshengzizhuYesnoTypesShenhe() {
                var mymessage = confirm("真的要确定这个审核结果吗？");
                if (mymessage == true) {
                    let data = {};
                    data["id"] = $("#xueshengzizhuYesnoTypesId").val();
                    if($("#xueshengzizhuYesnoTypes option:selected").val() == 2 || $("#xueshengzizhuYesnoTypes option:selected").val() ==3){
                        data["xueshengzizhuYesnoTypes"] = $("#xueshengzizhuYesnoTypes option:selected").val();//获取选中的审核状态
                    }else{
                        alert("请选择审核状态")
                        return false;
                    }
                    data["xueshengzizhuYesnoText"] = $("#xueshengzizhuYesnoText").val();
                    httpJson("xueshengzizhu/shenhe", "POST", data, (res) => {
                        if(res.code == 0){
                            alert('审核成功');
                            getDataList();
                        }else{
                        ...
                        $('#xueshengzizhuYesnoTypesModal').modal('hide');
                        $("#xueshengzizhuYesnoTypes").val(1);
                        $("#xueshengzizhuYesnoTypesId").val(null);
                        $("#xueshengzizhuYesnoText").val(null);
                    });
                }else {
                    $('#xueshengzizhuYesnoTypesModal').modal('hide');
                    $("#xueshengzizhuYesnoTypes").val(1);
        ...
        //当前表的下拉框赋值
            ...
            xueshengzizhuTypesSelectSearch();
                                                 
            xueshengzizhuYesnoTypesSelectSearch();
